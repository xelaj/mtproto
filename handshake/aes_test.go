...
func TestTempAESKeys(t *testing.T) {
	...
	var (
		newNonce    = hexInt256("311C85DB234AA2640AFC4A76A735CF5B1F0FD68BD17FA181E1229AD867CC024D")
		serverNonce = hexInt128("A5CF4D33F4A11EA877BA4AA573907330")
		keyExpected = hexInt256("F011280887C7BB01DF0FC4E17830E0B91FBB8BE4B2267CB985AE25F33B527253")
		ivExpected  = hexInt256("3212D579EE35452ED23E0D0C92841AA7D31B2E9BDEF2151E80D15860311C85DB")
	)
	key, iv := TempAESKeys(newNonce, serverNonce)
	if key != keyExpected {
		t.Error("invalid key")
	} else if iv != ivExpected {
		t.Error("invalid iv")
	}

	encryptedAnswer := Hexed("28A92FE20173B347A8BB324B5FAB2667C9A8BBCE6468D5B509A4CB" +
	...
	expectedAnswer := Hexed("BA0D89B53E0549828CCA27E966B301A48FECE2FCA5CF4D33F4A1" +
		...
		"5C99C0FB9FB67BFF56D7D4481B634514FBA3488C4CDA2FC0659990E8E868B28632875A9AA703BCDCE8FCB7AE551")
